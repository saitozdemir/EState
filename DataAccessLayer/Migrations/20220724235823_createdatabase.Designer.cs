...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220724235823_createdatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Entity.District", b =>
                {
                    b.Property<int>("DistrictId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Entity.GeneralSettings", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entity.Images", b =>
                {
            ...
            modelBuilder.Entity("EntityLayer.Entity.Neighbourhood", b =>
                {
                    b.Property<int>("NeighbourhoodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Entity.Situation", b =>
                {
                    b.Property<int>("SituationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Entity.Type", b =>
                {
                    b.Property<int>("TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EntityLayer.Entity.Advert", b =>
                {
                    b.HasOne("EntityLayer.Entity.Neighbourhood", "Neighbourhood")
                        .WithMany()
                        .HasForeignKey("NeighbourhoodId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntityLayer.Entity.Type", "Type")
                        .WithMany("Adverts")
            ...
            modelBuilder.Entity("EntityLayer.Entity.Neighbourhood", b =>
                {
                    b.HasOne("EntityLayer.Entity.District", "District")
            ...
            modelBuilder.Entity("EntityLayer.Entity.Type", b =>
                {
                    b.HasOne("EntityLayer.Entity.Situation", "Situation")
                        .WithMany("Types")
